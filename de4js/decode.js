self.addEventListener('message', function(e) {
  ...
  if (packer === 'evalencode') {
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/Romeo6389/VnByst@javascript/de4js/aadecode.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/Romeo6389/VnByst@javascript/de4js/jjdecode.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/Romeo6389/VnByst@javascript/de4js/urlencode_unpacker.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/Romeo6389/VnByst@javascript/de4js/p_a_c_k_e_r_unpacker.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/Romeo6389/VnByst@javascript/de4js/javascriptobfuscator_unpacker.js');
    ...
    try {
      self.importScripts('https://cdn.jsdelivr.net/gh/Romeo6389/VnByst@javascript/de4js/myobfuscate_unpacker.js');
